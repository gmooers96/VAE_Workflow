...
def sample_latent_space_var(vae_encoder, train_data, test_data, id, dataset_min, dataset_max, dataset_type): 
    ...
    #np.save("./model_graphs/latent_space/4K_Full_Z_PCA_Latent_Space__{}".format(id), z_test)
    ...
    #np.save("./model_graphs/latent_space/4K_3D_PCA_Latent_Space__{}".format(id), z_test_pca)
